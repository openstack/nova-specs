...
QEMU will natively decrypted these ``LUKSv1`` ephemeral disks for us using the
...
.. [1] https://specs.openstack.org/openstack/nova-specs/specs/wallaby/approved/ephemeral-encryption.html
